...
* Weapon: Spear.
*/
class EliteWeapon_Spear extends AOCWeapon_Spear;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_Spear'
	...
	RecoveryAnimations(1)=(AnimationName=3p_spear_stab02recover,ComboAnimation=3p_spear_stab021recover,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.725,fBlendInTime=0.1,fBlendOutTime=0.1,bLastAnimation=true)

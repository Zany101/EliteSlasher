...
class EliteWeapon_ThrowingAxe extends AOCWeapon_ThrowingAxe;
...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[5]=(Damage=50,InitialSpeed=2300.0,MaxSpeed=2800.0,AmmoCount=2,InitialGravityScale=0.85,Drag=0.0000045,PitchCorrection=0)
	iFeintStaminaCost=0
	WeaponFontSymbol="R"

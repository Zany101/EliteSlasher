...
* Crossbow.
*/
class EliteWeapon_HeavyCrossbow extends EliteWeapon_Crossbow;
...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[3]=(Damage=89,InitialSpeed=7200.0,MaxSpeed=7700.0,AmmoCount=10,InitialGravityScale=0.25,Drag=0.000003,PitchCorrection=0)

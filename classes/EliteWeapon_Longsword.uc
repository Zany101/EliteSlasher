...
*/
class EliteWeapon_Longsword extends AOCWeapon_Longsword;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_Longsword'
	...
	AlternativeMode=class'EliteWeapon_Longsword1H'
	...
	// Extra animation required (Mirrored from default stab)
	// WindupAnimations(2)=(AnimationName=3p_longsword_stabdowntoup02,ComboAnimation=,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.65,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
	...
	// Extra animation required (Mirrored from default stab)
	// ReleaseAnimations(2)=(AnimationName=3p_longsword_stabrelease02,ComboAnimation=3p_longsword_stabrelease02,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longsword_Attack_03',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.4,fBlendInTime=0.0,fBlendOutTime=0.0,bLastAnimation=false)
	...
	// Extra animation required (Mirrored from default stab)
	// RecoveryAnimations(2)=(AnimationName=3p_longsword_stabrecover02,ComboAnimation=3p_longsword_stabrecover02,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.85,fBlendInTime=0.10,fBlendOutTime=0.1,bLastAnimation=true)

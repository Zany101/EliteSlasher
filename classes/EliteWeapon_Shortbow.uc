...
* Longbow.
*/
class EliteWeapon_Shortbow extends EliteWeapon_Longbow
	dependson(AOCPawn);
...
DefaultProperties
{
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=44,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=25,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=45,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=25,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=10,InitialSpeed=4500.0,MaxSpeed=4500.0,AmmoCount=25,InitialGravityScale=0.6,Drag=0.000004,PitchCorrection=0)

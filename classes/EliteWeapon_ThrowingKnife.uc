...
*/
class EliteWeapon_ThrowingKnife extends AOCWeapon_ThrowingKnife;
...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[5]=(Damage=32,InitialSpeed=2500.0,MaxSpeed=3000.0,AmmoCount=4,InitialGravityScale=0.90,Drag=0.000005,PitchCorrection=200)
	iFeintStaminaCost=0
	WeaponFontSymbol="S"
	WeaponReach=100

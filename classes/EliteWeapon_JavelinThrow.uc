...
class EliteWeapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_JavelinThrow'
	...
	AlternativeMode=class'EliteWeapon_JavelinMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=70,InitialSpeed=2700.0,MaxSpeed=3200.0,AmmoCount=4,InitialGravityScale=0.8,Drag=0.000003,PitchCorrection=0)

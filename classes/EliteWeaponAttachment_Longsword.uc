...
*/
class EliteWeaponAttachment_Longsword extends AOCWeaponAttachment_Longsword;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'EliteWeapon_Longsword'
	WeaponSocket=wep2hpoint

	bUseAlternativeKick=true

	AttackTypeInfo(0)=(fBaseDamage=84.0, fForce=30000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)

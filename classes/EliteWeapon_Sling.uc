...
*/
class EliteWeapon_Sling extends EliteRangeWeapon;
...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[7]=(MinDamage=25.0f,Damage=49,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=15,InitialGravityScale=0.65,Drag=0.0000055,PitchCorrection=0,bInfiniteAmmo=false,MinimumFireTime=0.6)
	iFeintStaminaCost=0
	WeaponFontSymbol="K"

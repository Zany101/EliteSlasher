...
*/
class EliteWeapon_Messer extends AOCWeapon_Messer;
...
Begin Object class=AnimNodeSequence Name=MeshSequenceA
	...
	AttachmentClass=class'EliteWeaponAttachment_Messer'
	...
	AlternativeMode=class'EliteWeapon_Messer1H'
	...
	ReleaseAnimations(1)=(AnimationName=3p_longsword_slash02release,ComboAnimation=3p_longsword_slash021release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.messer_attack_02',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.0,fBlendOutTime=0.0,bLastAnimation=false)

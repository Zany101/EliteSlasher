...
*/
class EliteWeapon_HeavyJavelinMelee extends AOCWeapon_HeavyJavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_HeavyJavelin'
	...
	bCanDodge=false
	AlternativeMode=class'EliteWeapon_HeavyJavelinThrow'

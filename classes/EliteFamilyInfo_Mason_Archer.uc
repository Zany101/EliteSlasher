class EliteFamilyInfo_Mason_Archer extends AOCFamilyInfo_Mason_Archer;
...
DefaultProperties
{
	...
	NewPrimaryWeapons(3)=(CWeapon=class'EliteWeapon_Crossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(4)=(CWeapon=class'EliteWeapon_LightCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(5)=(CWeapon=class'EliteWeapon_HeavyCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(6)=(CWeapon=class'EliteWeapon_JavelinMelee',CForceTertiary=(class'EliteWeapon_Buckler_Mason'))
	NewPrimaryWeapons(7)=(CWeapon=class'EliteWeapon_ShortSpearMelee',CForceTertiary=(class'EliteWeapon_Buckler_Mason'))
	NewPrimaryWeapons(8)=(CWeapon=class'EliteWeapon_HeavyJavelinMelee',CForceTertiary=(class'EliteWeapon_Buckler_Mason'))
	...
	NewTertiaryWeapons(2)=(CWeapon=class'EliteWeapon_Buckler_Mason',bEnabledDefault=false)

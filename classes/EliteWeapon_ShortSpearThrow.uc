...
class EliteWeapon_ShortSpearThrow extends AOCWeapon_ShortSpearThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_ShortSpearThrow'
	...
	AlternativeMode=class'EliteWeapon_ShortSpearMelee'

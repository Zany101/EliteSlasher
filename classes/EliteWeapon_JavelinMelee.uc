...
*/
class EliteWeapon_JavelinMelee extends AOCWeapon_JavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_Javelin'
	...
	bCanDodge=false
	AlternativeMode=class'EliteWeapon_JavelinThrow'

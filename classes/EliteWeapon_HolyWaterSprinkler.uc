...
*/
class EliteWeapon_HolyWaterSprinkler extends AOCWeapon_HolyWaterSprinkler;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_HolyWaterSprinkler'
	...
	WindupAnimations(1)=(AnimationName=3p_1hsharp_slash02downtoup,ComboAnimation=3p_1hsharp_slash021downtoup,AlternateAnimation=3p_1hsharp_slash021altdowntoup,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.mace_windup',bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false)

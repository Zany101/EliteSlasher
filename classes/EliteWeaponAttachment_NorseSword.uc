...
*/
class EliteWeaponAttachment_NorseSword extends AOCWeaponAttachment_NorseSword;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponID=EWEP_Norse
	WeaponClass=class'EliteWeapon_NorseSword'
	...
	AttackTypeInfo(2)=(fBaseDamage=59.0, fForce=22500, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)

...
*/
class EliteWeapon_Longsword1H extends AOCWeapon_Longsword1H;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_Longsword1H'
	...
	AlternativeMode=class'EliteWeapon_Longsword'

class EliteWeapon_OilPot extends AOCWeapon_OilPot;
...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=1500.0,MaxSpeed=2000.0,AmmoCount=1,InitialGravityScale=0.9,Drag=0.000001,PitchCorrection=60.0)
	iFeintStaminaCost=0
	WeaponFontSymbol="k"
	WeaponReach=100

...
* Longbow.
*/
class EliteWeapon_Longbow extends EliteRangeWeapon
	dependson(AOCPawn);
...
DefaultProperties
{
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=52,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=15,InitialGravityScale=0.4,Drag=0.0000030,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=53,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=15,InitialGravityScale=0.4,Drag=0.0000030,PitchCorrection=0)

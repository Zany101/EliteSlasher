...
class EliteWeapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_HeavyJavelinThrow'
	...
	AlternativeMode=class'EliteWeapon_HeavyJavelinMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=90,InitialSpeed=2600,MaxSpeed=3100,AmmoCount=3,InitialGravityScale=0.85,Drag=0.0000035,PitchCorrection=0)

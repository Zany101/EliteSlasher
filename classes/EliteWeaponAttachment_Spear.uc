...
*/
class EliteWeaponAttachment_Spear extends AOCWeaponAttachment_Spear;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponID=EWEP_Spear
	WeaponClass=class'EliteWeapon_Spear'
	...
	AttackTypeInfo(1)=(fBaseDamage=70.0, fForce=31500, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)

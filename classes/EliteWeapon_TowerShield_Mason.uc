...
*/
class EliteWeapon_TowerShield_Mason extends AOCWeapon_TowerShield_Mason;
...
DefaultProperties
{
	...
	OtherTeamWeapon(EFAC_AGATHA)=class'EliteWeapon_TowerShield_Agatha'

	/*
	 * Formerly in UDKNewWeapon.ini - [AOC.AOCWeapon_TowerShield_Mason]
	 */
	ShieldStaminaDrainDelay = 99.0
	WeaponFontSymbol=">"
	WeaponReach=100

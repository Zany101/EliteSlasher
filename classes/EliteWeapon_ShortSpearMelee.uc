...
*/
class EliteWeapon_ShortSpearMelee extends AOCWeapon_ShortSpearMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_ShortSpear'
	...
	bCanDodge=false
	AlternativeMode=class'EliteWeapon_ShortSpearThrow'

class EliteRangeWeapon extends AOCRangeWeapon;
...
simulated function ChangeProjectileType(class<AOCProjectile> Proj) {
	...
	if (class<EliteWeapon_Crossbow>(Class) != none && AOCOwner.PawnInfo.myTertiary == class'AOCWeapon_ExtraAmmo')
...
simulated state Active {
	simulated function BeginFire(byte FireModeNum) {
		...
		else if (bLoaded || (FireModeNum == Attack_Overhead && EliteWeapon_Crossbow(self) != none))

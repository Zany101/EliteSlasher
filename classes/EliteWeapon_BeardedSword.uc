...
*/
class EliteWeapon_BeardedSword extends AOCWeapon_Longsword;
...
DefaultProperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_BeardedSword'
	...
	AlternativeMode=class'EliteWeapon_Bearded'

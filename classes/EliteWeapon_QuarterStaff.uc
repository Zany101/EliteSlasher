...
* Quarter Staff.
*/
class EliteWeapon_QuarterStaff extends AOCWeapon_QuarterStaff;
...
defaultproperties
{
	...
	AttachmentClass=class'EliteWeaponAttachment_QuarterStaff'
	...
	WindupAnimations(0)=(AnimationName=3p_qstaff_slash01downtoup,ComboAnimation=3p_qstaff_slash011downtoup,AlternateAnimation=3p_qstaff_slash011altdowntoup,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.4,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false)
	WindupAnimations(1)=(AnimationName=3p_qstaff_slash02downtoup,ComboAnimation=3p_qstaff_slash021downtoup,AlternateAnimation=3p_qstaff_slash021altdowntoup,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false)

...
* Warbow.
*/
class EliteWeapon_Warbow extends EliteWeapon_Longbow;
...
DefaultProperties
{
	...
	// 0 - Bodkin
 	...
 	// 5 - Default
	// 6 - Warbow arrow
	ConfigProjectileBaseDamage[0]=(Damage=67,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=15,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=70,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=15,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	...
	ConfigProjectileBaseDamage[3]=(Damage=0,InitialSpeed=6000.0,MaxSpeed=8000.0,AmmoCount=15,InitialGravityScale=1.0,Drag=0.0000011,PitchCorrection=300.0)
	ConfigProjectileBaseDamage[4]=(Damage=0,InitialSpeed=6000.0,MaxSpeed=8000.0,AmmoCount=15,InitialGravityScale=1.0,Drag=0.0000011,PitchCorrection=300.0)
	ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=6000.0,MaxSpeed=8000.0,AmmoCount=15,InitialGravityScale=1.0,Drag=0.0000011,PitchCorrection=300.0)
	ConfigProjectileBaseDamage[6]=(Damage=65,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=15,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	iFeintStaminaCost=0
	WeaponFontSymbol="@"
	WeaponReach=100

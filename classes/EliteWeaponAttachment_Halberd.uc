...
*/
class EliteWeaponAttachment_Halberd extends AOCWeaponAttachment_Halberd;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'EliteWeapon_Halberd'
	...
	AttackTypeInfo(2)=(fBaseDamage=75.0, fForce=35500, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
